...
def perfect_square(score):
   return pow(min_num(score), 2) == score

def next_perfect_square(score):
    return pow(min_num(score) + 1, 2)
# END PROBLEM 4
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    pre = score
    increase = square_update(0, score, opponent_score) - pre
